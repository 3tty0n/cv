\begin{rubric}{Grants, Honours and Scholarships}
    \entry*[2025] \textbf{Shortlisted Candidate}, Tenure-Track Assistant
    Professor in Computer Engineering, Aalto University (shortlisted from 55
    applicants).
  ...
  \entry*[2025] \textbf{Graint-in-Aid for Early-Career Scientists}. Research
  expenses are convered by KAKENHI.
  \entry*[2024] \textbf{Graint-in-Aid for Research Activity Start-up}. Research
  expenses are convered by KAKENHI.
  \entry*[2023] \textbf{Long-Term Performance Award.}
  Award from IBM, based on skills needed for the future, long-term caree
  potential, and strong indivisual performance.
